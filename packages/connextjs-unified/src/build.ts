...
export async function buildOptimized(
  preset: keyof typeof buildPresets = 'production',
  customOptions?: any
) {
...
export function createBuildPlugin(preset: keyof typeof buildPresets = 'production') {
